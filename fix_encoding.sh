#!/bin/bash
# Script para arreglar la codificación de archivos con problemas de UTF-8

# Reescribimos el archivo original con una codificación correcta
cat << 'EOF' > Controllers/freeEventController.js
...
echo "Fixed encoding for freeEventController.js"